    ...
    for (;;)
    {
        ...
        else if ((stoi(a)>0)&&(stoi(a)<3))
        {
            ...
            if (stoi(a)==1)
            {
                ...
                {
                case 1:
                    cout<<"Here is a list of main parachute systems:"<<endl;
                    break;
                case 2:
                    cout<<"Here it is. List of main parachute systems:"<<endl;
                    break;
                case 3:
                    cout<<"Here, as ordered. List of main parachute systems:"<<endl;
                    break;
                }
            }
            else
            {
                ...
                {
                case 1:
                    cout<<"Here is a list of reserve parachute systems:"<<endl;
                    break;
                case 2:
                    cout<<"Here it is. List of reserve parachute systems:"<<endl;
                    break;
                case 3:
                    cout<<"Here, as ordered. List of reserve parachute systems:"<<endl;
                    break;
                }
            }
            int j=0;
